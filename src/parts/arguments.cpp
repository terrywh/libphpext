...
namespace php {
	...
	arguments& arguments::_bool(const char* _name, zend_bool _ref, zend_bool _null) {
	...
	arguments& arguments::_long(const char* _name, zend_bool _ref, zend_bool _null) {
		zend_internal_arg_info info;
		info.name = _name;
		info.class_name = nullptr;
	...
	arguments& arguments::_double(const char* _name, zend_bool _ref, zend_bool _null) {
		zend_internal_arg_info info;
		info.name = _name;
		info.class_name = nullptr;
	...
	arguments& arguments::_string(const char* _name, zend_bool _ref, zend_bool _null) {
		zend_internal_arg_info info;
		info.name = _name;
		info.class_name = nullptr;
	...
	arguments& arguments::_array(const char* _name, zend_bool _ref, zend_bool _null) {
		zend_internal_arg_info info;
		info.name = _name;
		info.class_name = nullptr;
	...
	arguments& arguments::_callable(const char* _name, zend_bool _null) {
		zend_internal_arg_info info;
		info.name = _name;
		info.class_name = nullptr;
	...
	arguments& arguments::_object(const char* _name, const char* _class, zend_bool _null) {
		zend_internal_arg_info info;
		info.name = _name;
