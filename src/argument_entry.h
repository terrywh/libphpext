...
namespace php {
    ...
    public:
        // 无类型参数
        argument_entry(const char* name, type_desc desc)
        : zend_internal_arg_info { name, desc, nullptr } {}
        // 基础类型参数
        argument_entry(const char*  name, type_code type_hint, bool nullable = false, bool byref = false, bool variadic = false)
    ...
    public:
        ...
        // 返回基础类型
        return_entry(type_code type_hint, bool nullable = false, bool byref = false)
