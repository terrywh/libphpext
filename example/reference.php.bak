...
// var_dump( $cb(3) );
// echo "========================================================\n";
// echo "test_function_6:\n";
// echo "--------------------------------------------------------\n";
// var_dump( test_function_6("abc", 123, ["a", "b", "c"], new DateTime()) );
// echo "========================================================\n";
// echo "test_class_1:\n";
// echo "--------------------------------------------------------\n";
// $obj = new test_class_1();
// var_dump($obj);
// echo "test_class_1::method_1:\n";
// $obj->method_1("this is the new value for property_1");
// var_dump($obj->property_1);
// echo "method_2:\n";
// $obj->method_2("this is the new value for property_2");
// var_dump($obj->property_2);
// echo "    method_3:\n";
// var_dump($obj->method_3());
